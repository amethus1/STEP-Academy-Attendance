...
export const ChevronUpIcon: React.FC<IconProps> = ({ className = "h-4 w-4" }) => (
...
export const SpinnerIcon: React.FC<IconProps> = ({ className = "h-4 w-4" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className={`${className} animate-spin`} aria-hidden="true">
