...
import { useHolidays, useAddHoliday, useDeleteHoliday } from '../../hooks/useAttendance';
...
export const HolidaysPage: React.FC = () => {
  ...
  if (isLoading) return <div className="text-center p-8">Loading holiday data...</div>;
              ...
              {sortedHolidays.length > 0 ? sortedHolidays.map(holiday => (
                <li key={holiday.date} className="py-3 flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-slate-400 hover:text-rose-500 p-2 rounded-full hover:bg-rose-50 dark:hover:bg-rose-900/50 transition-colors"
                  >
                    <TrashIcon />
                  </button>
                </li>
